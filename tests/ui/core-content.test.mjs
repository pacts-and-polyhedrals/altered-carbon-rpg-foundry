...
test('Foundry manifest and data models register ammunition and drug Item types',()=>{
  ...
  assert.equal(manifest.download,`${manifest.url}/releases/download/v${manifest.version}/altered-carbon-rpg-v${manifest.version}.zip`);
...
test('Rules Browser and GM Guide expose the v1.3 Core Equipment Library',()=>{
  ...
  assert.ok(guide.includes(`const GUIDE_VERSION='${json('system.json').version}'`));
